/*!jQuery v1.12.4 | (c) jQuery Foundation | jquery.org/license*/ !(function (
  ...
  function X(a, b, c, d) {
    var e,
      ...
      k =
        (n.cssNumber[b] || ('px' !== j && +i)) && U.exec(n.css(a, b));
    if (k && k[3] !== j) {
      (j = j || k[3]), (c = c || []), (k = +i || 1);
  ...
  (n.event = {
    ...
    l.change ||
      (n.event.special.change = {
        ...
        teardown: function () {
          return (
            n.event.remove(this, '._change'), !ka.test(this.nodeName)
          );
        },
      }),
    l.focusin ||
  ...
  function Da(a) {
    return (
      (a.type = (null !== n.find.attr(a, 'type')) + '/' + a.type), a
    );
  }
  function Ea(a) {
  ...
  function fb(a, b, c) {
    var d = !0,
      ...
      f = Ra(a),
      g =
        l.boxSizing && 'border-box' === n.css(a, 'boxSizing', !1, f);
    if (0 >= e || null == e) {
      if (
        ((e = Sa(a, b, f)),
